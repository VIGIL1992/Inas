...
<body>
				...
				<div class="container-fluid" >
					...
					<div class="collapse navbar-collapse main-menu">
                        <div class="nav-menu-wrapper">
                            <ul class="navbar-nav mr-auto" id="menu" dir="rtl">
                        ...
                        <!-- <div class="header-btn d-inline-flex">
                            <a href="tel:+789859664" class="btn-phone"><i class="fa-solid fa-phone-volume"></i>+971 123 456 789</a>
    ...
    <!-- Hero Section Start -->
    <div class="hero hero1 bg-section parallaxie" id="home" style="background-position: center 1px !important;" dir="rtl">
